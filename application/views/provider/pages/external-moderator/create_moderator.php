            ...
            <div class="col-lg-12 mb-1">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="h6 text-uppercase mb-0"><?= $name ?> EXTERNAL MODERATOR</h3>
                    </div>
                    <?php
                    ...
                    <?php } ?>
                    <div class="card-body">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" id="CreateModeratorproviderForm">
                            <!-- <div class="line"></div> -->
...
<script>
    ...
    $(function() {
        ...
        $("#CreateModeratorproviderForm").validate({
            'rules': {
                'fullname': {
                    'required': true,
                    'full_name': true
            ...
            success: function(data) {
                ...
                $.each(data, function(i, star) {
                    if (i == 'error') {
                        ...
                        $('.district_option').html('<option value="" hidden>Select District</option>' + option);
                        $('#district-error').hide();
                    }
                });
            ...
            success: function(data) {
                ...
                $.each(data, function(i, star) {
                    if (i == 'error') {
                        ...
                        $('#city').html('<option value="" hidden>Select City</option>' + option);
                        $('#city-error').hide();
                    }
                });
