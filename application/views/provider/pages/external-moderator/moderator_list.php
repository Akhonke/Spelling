            ...
            <div class="col-lg-12 mb-1">
                <div class="card">
                    <div class="card-header">
                        <h3 class="h6 text-uppercase mb-0">External MODERATOR LIST</h3>
                    </div>
                    <div class="card-body">
                                        ...
                                        <tr id="del-<?= $row->id ?>">
                                            ...
                                            <td>
                                                ...
                                                <?php if ($res['is_edit'] == 1) { ?>
                                                    ...
                                                    <a href="create-externalmoderator-user?id=<?= $row->id ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>
                                                <?php }
                                                if ($res['is_delete'] == 1) { ?>

                                                    <a href="javascript:;" class="btn btn-danger btn-sm" style="margin:5px 0 0" onclick="deleterecord('external_moderator&behalf','id',<?= $row->id ?>)"><i class="fa fa-trash"></i></a>
                                                <?php } ?>
                                            </td>
                                        </tr>
                                <?php $i++;
