            ...
            <div class="col-lg-12 mb-1">
                <div class="card">
                    ...
                    <div class="card-header">
                        <h3 class="h6 text-uppercase mb-0"><?= $name ?> FACILITATOR</h3>
                    </div>
                    <?php
                    ...
                    <?php } ?>
                    <div class="card-body">
                        <form class="form-horizontal" method="post" enctype="multipart/form-data" id="CreatefacilitatorProviderForm">
                            <!-- <div class="line"></div> -->
                            <div class="form-group row">
                               ...
                               <div class="col-md-6">
                                    ...
                                    <select class="form-control classname" name="classname">
                                        ...
                                        ?>
                                            <option value="<?= $value->class_name  ?>" <?php
                                                                                        if (isset($record)) {

                                                                                            if ($record->classname == $value->class_name) { ?> selected="selected" <?php }
                                                                                                                                                            } ?>><?= $value->class_name  ?>
                                            </option>
                                        <?php }
                                        ?>
...
<script>
    ...
    $(function() {
        ...
        $("#CreatefacilitatorProviderForm").validate({
            'rules': {
                'fullname': {
                    'required': true,
                    'fname': true
