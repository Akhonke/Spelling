            ...
            <div class="col-lg-12 mb-1">
                <div class="card">
                    <div class="card-header">
                        <h3 class="h6 text-uppercase mb-0">My Moderation Report</h3>
                    </div>
                    <div class="card-body">
                            ...
                            <tbody>
                                ...
                                ?>
                                        <tr id="del-<?= $value['id'] ?>" class="filters">
                                            ...
                                            <td><?= $standards_val ?></td>
                                            <td>
                                                <a href="external-moderator-user_listing?id=<?= $value['id'] ?>" class="btn btn-info btn-sm"><i class="fa fa-view"></i>View</a>
