            ...
            <div class="col-lg-12 mb-1">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h3 class="h6 text-uppercase mb-0">Internal Moderators List</h3>
                            ...
                            <table class="table table-striped table-bordered " style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($moderator)) {
                                        ...
                                        foreach ($moderator as $key_one => $value) {
                                                ...
                                                <tr id="del-<?= $row->id ?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                                    ...
                                                                    <div class="text-center" style="display:inline-block; margin:0 5px; border:1px solid #000;padding:5px"><?= $value['acreditations'] ?><br>
                                                                        ...
                                                                        <img src="<?= BASEURL . 'uploads/moderator/acreditationsfiles/' . $value['acreditations_file'] ?>" width="50px">
                                                                    </div>
                                                    ...
                                                    <td>
                                                      ...
                                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        ...
                                                        <!-- <a href="projectmanager-create-moderator?id=<?= $row->id ?>" class="btn btn-info btn-sm"><i

                                                        class="fa fa-edit"></i></a>

                                                <a href="javascript:;" class="btn btn-danger btn-sm" style="margin:5px 0 0"onclick="deleterecord('moderator&behalf','id',<?= $row->id ?>)"><i
...
<script>
    function view() {
        ...
        //     $(event.relatedTarget).closest("tr").find("td:eq(16) div").each(function() {
