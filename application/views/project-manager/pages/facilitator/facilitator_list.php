            ...
            <div class="col-lg-12 mb-1">
                ...
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <h3 class="h6 text-uppercase mb-0">Facilitators List</h3>
                            ...
                            <table class="table table-striped table-bordered " style="width:100%">
                                ...
                                <tbody>
                                    ...
                                    if (!empty($facilitator)) {
                                        ...
                                        foreach ($facilitator as $facilitar) {
                                            foreach ($facilitar as $key => $row) {
                                                ...
                                                <tr id="del-<?= $row->id ?>">
                                                    ...
                                                    <td>
                                                        ...
                                                        ?>
                                                                    ...
                                                                    <div class="text-center"><?= $value['acreditations'] ?><br>
                                                                    <!-- <a href="<?= BASEURL . 'uploads/facilitator/acreditationsfiles/' . $value['acreditations_file'] ?>' ?>" download class="btn btn-sm btn-info">Download <i class="fa fa-download" aria-hidden="true"></i></a> -->
                                                                        <!-- <img src="<?= BASEURL . 'uploads/facilitator/acreditationsfiles/' . $value['acreditations_file'] ?>" width="50px"> -->
                                                                        <a href="<?= BASEURL .'uploads/facilitator/acreditationsfiles/'.$value['acreditations_file']?>" download class="btn btn-sm btn-info">Download <i class="fa fa-download" aria-hidden="true"></i></a>
                                                                    </div>
                                                    ...
                                                    <td>
                                                      ...
                                                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                        ...
                                                        <!-- <a href="projectmanager-create-facilitator?id=<?= $row->id ?>" class="btn btn-info btn-sm"><i

                                                        class="fa fa-edit"></i></a>

                                                <a href="javascript:;" class="btn btn-danger btn-sm" style="margin:5px 0 0"onclick="projectmanagerdeletedataFacilitator('facilitator&behalf','id','<?= $row->id ?>','<?= $trainer_nm ?>')"><i
